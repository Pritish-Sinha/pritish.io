				...
				<Left visibility={visible}>
					<section>
						...
						<p className="bio">
							...
							, India. I like to work with TS, JS and it's various frameworks. Python is my 2nd language of choice.I have built many projects on AI-ML.This website shows my contact details, past experience along with some of the projects that I have worked on.
						</p>
						...
						<div className="profile">
							...
							<a href="mailto:bpb1789@gmail.com">bpb1789@gmail.com</a>
						</div>
						<div className="details">
							<Link href="https://github.com/Pritish-Sinha" target="_blank">
								<FaGithub size={18} />
								<span>GitHub</span>
								<HiOutlineExternalLink size={16} />
							</Link>
							<Link
								href="https://www.linkedin.com/in/pritish-sinha31/"
								target="_blank"
							>
								<FaLinkedin size={18} />
								<span>Linkedin</span>
						...
						<div className="details">
							<Link href="https://twitter.com/PritishSinha10" target="_blank">
								<FaTwitter size={18} />
								<span>Twitter</span>
								<HiOutlineExternalLink size={16} />
							</Link>
							<Link
								href="https://drive.google.com/file/d/1anoI3HeCUXEQ6o1S472_VVCtoXEq-7UJ/view?usp=sharing"
								target="_blank"
							>
								<FaFile size={18} />
								<span>Resume</span>
